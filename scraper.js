...
class HikingEventScraper {
    ...
    isUpcomingEvent(dateStr) {
        ...
        console.log(`Comparing dates: Event(${eventDateOnly.toISOString()}) >= Current(${currentDateOnly.toISOString()})`);
                ...
                const events = await page.evaluate(() => {
                    ...
                    dateNodes.forEach(node => {
                        ...
                        if (container) {
                            ...
                            const possibleTitleElements = container.querySelectorAll('h1, h2, h3, h4, strong, b, .title');
